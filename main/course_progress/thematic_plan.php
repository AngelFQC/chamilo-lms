...
if ($action == 'thematic_plan_list') {            
        ...
        foreach ($default_thematic_plan_title as $id => $title) {
            ...
            $form->add_html_editor('description['.$id.']', get_lang('Description'), false, false, array('ToolbarStartExpanded'=>'false', 'ToolbarSet' => 'Training_Description', 'Width' => '80%', 'Height' => '150'));
	...
	$form->add_html_editor('description', get_lang('Description'), false, false, array('ToolbarStartExpanded'=>'false', 'ToolbarSet' => 'Training_Description', 'Width' => '80%', 'Height' => '150'));
