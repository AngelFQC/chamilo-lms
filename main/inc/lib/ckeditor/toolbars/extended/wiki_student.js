CKEDITOR.editorConfig = function( config ) {
    ...
    config.toolbar_Basic =
        [
            ...
            ['Undo','Redo'],
            ['Wikilink','Link','Image','flvPlayer','Flash','MP3','TableOC','mimetex','asciimath','asciisvg'],
            ['UnorderedList','OrderedList','Rule'],
            ['JustifyLeft','JustifyCenter','JustifyFull'],
            ['FontFormat','FontName','FontSize','Bold','Italic','Underline','TextColor','BGColor'],
            ['Toolbarswitch']
        ];
    config.toolbar_Full =
        [
            ...
            ['Image','imgmapPopup','flvPlayer','EmbedMovies','YouTube','Flash','MP3','googlemaps','Smiley','SpecialChar','mimetex','asciimath','asciisvg','fckeditor_wiris_openFormulaEditor','fckeditor_wiris_openCAS'],
            '/',
